...
class Character extends FlxSprite
{
	...
	public var heyTimer:Float = 0; // from Psych Engine -Shadow Mario-
	public var specialAnim:Bool = false; // from Psych Engine -Shadow Mario-

        public var HealthColor:Array<Int>;

	public var animationNotes:Array<Dynamic> = []; // from Psych Engine -Shadow Mario-
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
                                ...
                                HealthColor = [196, 94, 174];

                                //Week 7

			case 'tankman':
				tex = Paths.getSparrowAtlas('characters/Tank/tankmanCaptain', 'shared');
				frames = tex;
				...
				animation.addByPrefix('singUPmiss', 'Tankman UP note MISS', 24);
				animation.addByPrefix('singRIGHTmiss', 'Tankman Note Left MISS', 24);
				animation.addByPrefix('singDOWNmiss', 'Tankman DOWN note MISS', 24);
				animation.addByPrefix('singLEFTmiss', 'Tankman Right Note MISS', 24);
				...
				playAnim('idle');
                                ...
                                HealthColor = [225, 225, 225];

			case 'gf-tankmen':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/Tank/gfTankmen');
				frames = tex;
				...
				playAnim('danceRight');
                         ...
                         case 'bf-holding-gf':
				tex = Paths.getSparrowAtlas('characters/Tank/bfAndGF', 'shared');
				frames = tex;
				...
				animation.addByPrefix('singUPmiss', 'BF NOTE RIGHT MISS', 24);
				animation.addByPrefix('singRIGHTmiss', 'BF NOTE UP MISS', 24);
			...
			case 'bf-holding-gf-dead':
				frames = Paths.getSparrowAtlas('characters/Tank/bfHoldingGF-DEAD');
				...
				flipX = true;
                        ...
                        case 'pico-speaker':
				tex = Paths.getSparrowAtlas('characters/Tank/picoSpeaker');
				frames = tex;
                                ...
                                animation.addByIndices('shoot3-loop', 'Pico shoot 3', [50, 51, 52], "", 24, true);
                                animation.addByIndices('shoot1-loop', 'Pico shoot 1', [23, 24, 25], "", 24, true);
                                animation.addByIndices('shoot2-loop', 'Pico shoot 2', [57, 58, 59], "", 24, true);
                                animation.addByIndices('shoot4-loop', 'Pico shoot 4', [50, 51, 52], "", 24, true);
	...
	function loadMappedAnims():Void // Shadow Mario
	{
