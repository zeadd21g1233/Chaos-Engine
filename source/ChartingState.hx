	...
	**/
	...
	override function create()
	{
		...
		add(snapText);
                ...
                noteTypeText = new FlxText(0, 0, 0, styles[this.noteStyle], 32);
	...
	function addNoteUI():Void
	{
		...
		//var NoteTypeNames:Array<String> = CoolUtil.coolTextFile(Paths.txt('notetypenames'));

		var NotetypeDropDown = new FlxUIDropDownMenu(10, 200, FlxUIDropDownMenu.makeStrIdLabelArray(noteTypeList, true), function(character:String)
			{
                                currentType = Std.parseInt(character);
			        if(curSelectedNote != null && curSelectedNote[1] > -1) {
				        curSelectedNote[3] = noteStyle = currentType;
				        updateGrid();
			        }
		...
		var NotetypeLabel = new FlxText(10,180,64,'Note Type');
